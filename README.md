...
|    | F | [Managing files](cm/cm501-proj-m-manage-files.md#file-management) \[[slides](slides/sd034-proj-m-manage-files.pdf)\]<br>[Portfolio data requirements](cm/cm301-report-display-reqts.md#portfolio-data-requirements)<br>[Interacting with R](cm/cm101b-interacting-with-R.md#interacting-with-R)<br>[Data studio](cm/cm102-data-studio.md#data-studio)<br>Return reprints | Start acquiring data            |                                                                              |
