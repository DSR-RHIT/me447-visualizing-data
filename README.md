...
|    | F | [Managing files](cm/cm501-proj-m-manage-files.md#file-management) \[[slides](slides/sd034-proj-m-manage-files.pdf)\]<br>[Data studio](cm/cm102-data-studio.md#data-studio)<br>[Portfolio data requirements](cm/cm301-report-display-reqts.md#portfolio-data-requirements)<br>Return reprints                            | Start acquiring data            |                                                                              |
