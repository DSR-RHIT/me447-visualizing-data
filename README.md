...
| :- | :- | :------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | :------------------------------ | :--------------------------------------------------------------------------- |
| 1  | M | Course goals and outcomes \[[slides](slides/wk01-1-welcome.pdf)\]<br>[Syllabus](cm/cm001_course_syllabus.md#syllabus)<br>[Sign-out two reprints](cm/cm401_rhetoric_reprints.md#signout-reprints)                                                                                                   |                                 |                                                                              |
...
|    | R | Comparing distributions<br>[Strip plot](cm/cm201_strip-plot.md#strip-plot) \[[exercises](cm/cm201_strip-plot.md#exercises)\]<br>[Box plot](cm/cm202_boxplot.md#box-plot) \[[exercises](cm/cm202_boxplot.md#exercises)\]<br>[D1 requirements](cm/cm301_portfolio_display-reqts.md#D1-distributions) | D1 data acquired                |                                                                              |
...
|    | R | [Multiway dot plot](cm/cm203_multiway.md#multiway-dot-plot) \[[exercises](cm/cm203_multiway.md#exercises)\]<br>[D2 requirements](cm/cm301_portfolio_display-reqts.md#D2-multiway)                                                                                                                  | D2 data acquired                |                                                                              |
...
|    | R | Exploring correlations<br>Scatterplot \[exercises\]<br>[D3 requirements](cm/cm301_portfolio_display-reqts.md#D3-correlations)                                                                                                                                                                      | D3 data acquired                |                                                                              |
...
|    | T | Displaying injuries or fatalities ethically<br>Dot plot \[exercises\]<br>Line graph \[exercises\]<br>[D4 requirements](cm/cm301_portfolio_display-reqts.md#D4-injuries-or-fatalities)<br>![](resources/icon-moodle.png) Dragga and Voss ([2001](#ref-Dragga+Voss:2001)) Cruel pies                 |                                 | [Reading prompts](reports/reading-prompts.Rmd)                               |
|    | R | Factors \[exercises\]                                                                                                                                                                                                                                                                              | D4 data acquired                |                                                                              |
...
|    | T | Redesigning a graphical lie<br>Time series \[exercises\]<br>Using constant dollars \[exercises\]<br>[D5 requirements](cm/cm301_portfolio_display-reqts.md#D5-redesign-a-graphical-lie)                                                                                                             |                                 |                                                                              |
|    | R | Scales \[exercises\]                                                                                                                                                                                                                                                                               | D5 data acquired                |                                                                              |
|    | F | Presentations, practice, & portfolio studio                                                                                                                                                                                                                                                        |                                 | D4 graph & prose<br>[Presentation prompts](reports/presentation-prompts.Rmd) |
| 8  | M | Displaying multivariate data<br>Co-plot \[exercises\]<br>Scatterplot matrix \[exercises\]<br>Parallel coordinate \[exercises\]<br>[D6 requirements](cm/cm301_portfolio_display-reqts.md#D6-multivariate)                                                                                           | wk7 tutorials & exercises       |                                                                              |
...
Graph tutorials
  ...
  - [Multiway dot plot](cm/cm203_multiway.md#multiway-dot-plot)
  - Scatterplot  
  - Dot plot  
  - Line graph  
  - Time series  
...
Graph exercises
  ...
  - [Multiway dot plot exercises](cm/cm203_multiway.md#exercises)
