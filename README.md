...
| 2  | M | [R basics](cm/cm903-software-R-basics.md#R-basics) \[[exercises](cm/cm903-software-R-basics.md#exercises)\]<br>Graph basics with ggplot2 \[exercises\]                                                                                                                                                                  | wk1 lab complete                |                                                                              |
...
|    | F | [Managing files](cm/cm501-proj-m-manage-files.md#file-management) \[[slides](slides/sd034-proj-m-manage-files.pdf)\]<br>[Portfolio data requirements](cm/cm301-report-display-reqts.md#portfolio-data-requirements)<br>[Data studio](cm/cm102-data-studio.md#data-studio)<br>Return reprints                            | Start acquiring data            |                                                                              |
...
|    | T | Displaying injuries or fatalities ethically<br>Dot plot \[exercises\]<br>Line graph \[exercises\]<br>[D4 requirements](cm/cm301-report-display-reqts.md#D4-injuries-or-fatalities)<br>![](resources/icon-moodle.png) Dragga and Voss ([2001](#ref-Dragga+Voss:2001)) Cruel pies                                         |                                 | [Reading prompts](reports/reading-prompts-3.Rmd)                             |
...
|    | T | ![](resources/icon-moodle.png) Kostelnick ([2007](#ref-Kostelnick:2007)) Conundrum of clarity                                                                                                                                                                                                                           |                                 | [Reading prompts](reports/reading-prompts-4.Rmd)                             |
