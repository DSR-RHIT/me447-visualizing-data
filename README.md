...
|    | T | [D4 requirements:](cm/cm301-report-display-reqts.md#D4-injuries-or-fatalities) Graph injuries/fatalities ethically<br>[Dot plot](cm/cm206-graph-dot-plot.md#dot-plot) \[[exercises](cm/cm206-graph-dot-plot.md#exercises)\]<br>![](resources/icon-moodle.png) Dragga and Voss ([2001](#ref-Dragga+Voss:2001)) Cruel pies                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |                                                                                                                     | [Reading prompts 3](reports/reading-prompts-3.Rmd)                                                                                       |
|    | R | [Time and dates](cm/cm109-data-time-dates.md)<br>[Time series data](cm/cm110-data-time-series.md)<br>[Line graph](cm/cm207-graph-line-graph.md#line-graph) \[[exercises](cm/cm207-graph-line-graph.md#exercises)\]                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              | D4 data acquired                                                                                                    |                                                                                                                                          |
