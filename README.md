...
|    | R | Factors \[exercises\]<br>![](resources/icon-r4ds.png) [15.2 Creating factors](https://r4ds.had.co.nz/factors.html#creating-factors)<br>![](resources/icon-r4ds.png) [15.4 Modifying factor order](https://r4ds.had.co.nz/factors.html#modifying-factor-order)<br>![](resources/icon-r4ds.png) [15.5 Modifying factor levels](https://r4ds.had.co.nz/factors.html#modifying-factor-levels)                                                                                                                                                                                                                                                                                                                                                                                                                                                                       | D4 data acquired                                                                                                    |                                                                              |
