...
| :- | :- | :---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | :------------------------------ | :--------------------------------------------------------------------------- |
| 1  | M | Course goals and outcomes \[[slides](slides/sd011-course-welcome.pdf)\]<br>[Syllabus](cm/cm001-course-syllabus.md#syllabus)<br>[Sign-out two reprints](cm/cm401-rhetoric-reprints.md#signout-reprints)                                                                                                                  |                                 |                                                                              |
|    | T | Introduction to visual rhetoric<br>[Install software](cm/cm901-software-install.md#install-software)                                                                                                                                                                                                                    |                                 |                                                                              |
...
|    | F | [Managing files](cm/cm501-proj-m-manage-files.md#file-management) \[[slides](slides/wk03-4-file-management.pdf)\]<br>[Data studio](cm/cm102-data-studio.md#data-studio)<br>[Start acquiring data](cm/cm301-report-display-reqts.md#portfolio-display-requirements)<br>Return reprints                                   |                                 |                                                                              |
...
|    | R | Exploring correlations<br>Scatterplot \[exercises\]<br>[D3 requirements](cm/cm301-report-display-reqts.md#D3-correlations)                                                                                                                                                                                              | D3 data acquired                |                                                                              |
...
|    | T | Displaying injuries or fatalities ethically<br>Dot plot \[exercises\]<br>Line graph \[exercises\]<br>[D4 requirements](cm/cm301-report-display-reqts.md#D4-injuries-or-fatalities)<br>![](resources/icon-moodle.png) Dragga and Voss ([2001](#ref-Dragga+Voss:2001)) Cruel pies                                         |                                 | [Reading prompts](reports/reading-prompts.Rmd)                               |
...
|    | T | Redesigning a graphical lie<br>Time series \[exercises\]<br>Using constant dollars \[exercises\]<br>[D5 requirements](cm/cm301-report-display-reqts.md#D5-redesign-a-graphical-lie)                                                                                                                                     |                                 |                                                                              |
...
| 8  | M | Displaying multivariate data<br>Co-plot \[exercises\]<br>Scatterplot matrix \[exercises\]<br>Parallel coordinate \[exercises\]<br>[D6 requirements](cm/cm301-report-display-reqts.md#D6-multivariate)                                                                                                                   | wk7 tutorials & exercises       |                                                                              |
...
| 9  | M | Learning a new display type on your own<br>Cycle plot \[example\]<br>Financial (OHLC) plot \[example\]<br>Mosaic plot \[example\]<br>Linked micromaps \[example\]<br>Diverging stacked bar \[example\]<br>[D7 requirements](cm/cm301-report-display-reqts.md#D7-self-taught)                                            | wk8 tutorials & exercises       |                                                                              |
