...
| economics         | [ggplot2](https://github.com/tidyverse/ggplot2)                      | [time series data](cm110-data-time-series.md)                                                                                      | data.frame | 574x6     | US economic time series                                                      |
...
| download.file()        | utils          | [line graph](cm207-graph-line-graph.md)                                                                                                                                  |
...
| read.table()           | utils          | [data basics](cm101-data-basics.md), [line graph](cm207-graph-line-graph.md)                                                                                             |
...
| rename()               | dplyr          | [carpentry with joins](cm105-data-joins.md), [dot plot](cm206-graph-dot-plot.md), [strip plot](cm202-graph-strip-plot.md), [time series data](cm110-data-time-series.md) |
...
| year()                 | lubridate      | [time series data](cm110-data-time-series.md)                                                                                                                            |
| ymd()                  | lubridate      | [time and dates](cm109-data-time-dates.md)                                                                                                                               |
...
| dplyr          | rename()               | [carpentry with joins](cm105-data-joins.md), [dot plot](cm206-graph-dot-plot.md), [strip plot](cm202-graph-strip-plot.md), [time series data](cm110-data-time-series.md) |
...
| lubridate      | year()                 | [time series data](cm110-data-time-series.md)                                                                                                                            |
| lubridate      | ymd()                  | [time and dates](cm109-data-time-dates.md)                                                                                                                               |
...
| utils          | download.file()        | [line graph](cm207-graph-line-graph.md)                                                                                                                                  |
| utils          | read.table()           | [data basics](cm101-data-basics.md), [line graph](cm207-graph-line-graph.md)                                                                                             |
