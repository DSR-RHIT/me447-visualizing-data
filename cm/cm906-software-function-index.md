...
| midfielddegrees   | midfielddata   | [carpentry with joins](cm105-data-joins)                                                                                           | data.frame | 97640x5   | Graduation data for 98,000 undergraduates                |
| midfieldstudents  | midfielddata   | [carpentry with joins](cm105-data-joins)                                                                                           | data.frame | 97640x15  | Demographic data for 98,000 undergraduates               |
...
| build\_frame()         | wrapr          | [carpentry with joins](cm105-data-joins), [reshaping data](cm103-data-reshaping.md)                                                       |
...
| count()                | dplyr          | [carpentry with joins](cm105-data-joins)                                                                                                  |
| data()                 | utils          | [data basics](cm101-data-basics.md)                                                                                                       |
| date()                 | lubridate      | [working with factors](cm107-data-working-with-factors.md)                                                                                |
| distinct()             | dplyr          | [carpentry with joins](cm105-data-joins), [scatterplot](cm205-graph-scatterplot.md)                                                       |
...
| facet\_grid()          | ggplot2        | [carpentry with joins](cm105-data-joins), [dot plot](cm206-graph-dot-plot.md)                                                             |
...
| fct\_reorder()         | forcats        | [carpentry with joins](cm105-data-joins), [dot plot](cm206-graph-dot-plot.md), [working with factors](cm107-data-working-with-factors.md) |
...
| left\_join()           | dplyr          | [carpentry with joins](cm105-data-joins), [dot plot](cm206-graph-dot-plot.md)                                                             |
...
| rename()               | dplyr          | [carpentry with joins](cm105-data-joins), [dot plot](cm206-graph-dot-plot.md), [strip plot](cm202-graph-strip-plot.md)                    |
...
| sample\_n()            | dplyr          | [carpentry with joins](cm105-data-joins)                                                                                                  |
...
| str\_c()               | stringr        | [boxplot](cm203-graph-boxplot.md), [carpentry with joins](cm105-data-joins)                                                               |
| str\_remove\_all()     | stringr        | [carpentry with joins](cm105-data-joins)                                                                                                  |
| str\_replace()         | stringr        | [reshaping data](cm103-data-reshaping.md)                                                                                                 |
| str\_starts()          | stringr        | [carpentry with joins](cm105-data-joins)                                                                                                  |
| str\_sub()             | stringr        | [carpentry with joins](cm105-data-joins)                                                                                                  |
...
| unite()                | tidyr          | [carpentry with joins](cm105-data-joins)                                                                                                  |
...
| dplyr          | count()                | [carpentry with joins](cm105-data-joins)                                                                                                  |
| dplyr          | distinct()             | [carpentry with joins](cm105-data-joins), [scatterplot](cm205-graph-scatterplot.md)                                                       |
...
| dplyr          | left\_join()           | [carpentry with joins](cm105-data-joins), [dot plot](cm206-graph-dot-plot.md)                                                             |
...
| dplyr          | rename()               | [carpentry with joins](cm105-data-joins), [dot plot](cm206-graph-dot-plot.md), [strip plot](cm202-graph-strip-plot.md)                    |
| dplyr          | sample\_n()            | [carpentry with joins](cm105-data-joins)                                                                                                  |
...
| forcats        | fct\_reorder()         | [carpentry with joins](cm105-data-joins), [dot plot](cm206-graph-dot-plot.md), [working with factors](cm107-data-working-with-factors.md) |
...
| ggplot2        | facet\_grid()          | [carpentry with joins](cm105-data-joins), [dot plot](cm206-graph-dot-plot.md)                                                             |
...
| stringr        | str\_c()               | [boxplot](cm203-graph-boxplot.md), [carpentry with joins](cm105-data-joins)                                                               |
| stringr        | str\_remove\_all()     | [carpentry with joins](cm105-data-joins)                                                                                                  |
| stringr        | str\_replace()         | [reshaping data](cm103-data-reshaping.md)                                                                                                 |
| stringr        | str\_starts()          | [carpentry with joins](cm105-data-joins)                                                                                                  |
| stringr        | str\_sub()             | [carpentry with joins](cm105-data-joins)                                                                                                  |
...
| tidyr          | unite()                | [carpentry with joins](cm105-data-joins)                                                                                                  |
...
| wrapr          | build\_frame()         | [carpentry with joins](cm105-data-joins), [reshaping data](cm103-data-reshaping.md)                                                       |
