...
-   In the dialog box that appears, the *Install to Library* strip
    should show `C:/R/library [Default]` (in Windows) or
    `~/R/library [Default]` in Linux
...
Next we add some prompts and space for your responses.
...
The process of *Commit &gt; Pull &gt; Push* is how you upload your
latest version of your project to the GitHub repo.
