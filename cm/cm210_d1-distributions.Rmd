...
Using the same data, I suggest you create drafts of all three types and include in the portfolio only the one that best conveys the stories in the data. 
