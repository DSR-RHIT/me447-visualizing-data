...
Console to read more about it.
    ...
    ## $ gender     <chr> "male", NA, NA, "male", "female", "m...
...
in the Console to read more about it.
    ...
    ## Observations: 574
    ## Variables: 6
    ## $ date     <date> 1967-07-01, 1967-08-01, 1967-09-01, 1...
    ## $ pce      <dbl> 507.4, 510.5, 516.3, 512.9, 518.1, 525...
    ## $ pop      <int> 198712, 198911, 199113, 199311, 199498...
    ## $ psavert  <dbl> 12.5, 12.5, 11.7, 12.5, 12.5, 12.1, 11...
    ## $ uempmed  <dbl> 4.5, 4.7, 4.6, 4.9, 4.7, 4.8, 5.1, 4.5...
    ## $ unemploy <int> 2944, 2945, 2958, 3143, 3066, 3018, 28...
