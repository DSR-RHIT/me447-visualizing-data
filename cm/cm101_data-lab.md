...
Console to read more about it.
    ...
    ## $ skin_color <chr> "fair", "gold", "white, blue", "white", "l...
    ...
    ## $ films      <list> [<"Revenge of the Sith", "Return of the J...
...
in the Console to read more about it.
    ...
    ## Observations: 574
    ## Variables: 6
    ## $ date     <date> 1967-07-01, 1967-08-01, 1967-09-01, 1967-10...
    ## $ pce      <dbl> 507.4, 510.5, 516.3, 512.9, 518.1, 525.8, 53...
    ## $ pop      <int> 198712, 198911, 199113, 199311, 199498, 1996...
    ## $ psavert  <dbl> 12.5, 12.5, 11.7, 12.5, 12.5, 12.1, 11.7, 12...
    ## $ uempmed  <dbl> 4.5, 4.7, 4.6, 4.9, 4.7, 4.8, 5.1, 4.5, 4.1,...
    ## $ unemploy <int> 2944, 2945, 2958, 3143, 3066, 3018, 2878, 30...
