...
This example is adapted from [@Doumont2009book].
...
Let's fade out the data and overlay the means $\pm$ 1 standard deviation. Notice in this code how we can use *ggplot()* with no arguments, then use a different data frame and aesthetic in each *geom.* 
