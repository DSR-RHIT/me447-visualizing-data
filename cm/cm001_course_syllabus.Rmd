...
Success in this course depends on steady and productive weekly progress. Weekly assignments include 

- Obtaining data with structures appropriate to the assigned display types. Data should be obtained no later than the dates listed in the calendar.  
- Weekly practice R problems to learn the skills needed to create the portfolio, completed by the following Monday.  
- Weekly readings, completed before class on the assigned day. 
- Written reading responses (typically one every two weeks) completed before class on the day of discussion. 
