...
Generally, different displays in the portfolio have different structures with different numbers of quantitative and categorical variables. The basic data structure for all graphs in the portfolio are summarized in the table with additional notes below. 
...
df <- tribble(
	...
	"[D1 Distributions](cm210_d1_intro-distributions.md)", 
