...
|  | Thu | @Tufte1997 Challenger launch decision. Checkout a hard copy from me. [Written response form](cm/read-01_reading-response-form.pdf) required for discussion.|
| 2 | Tue | @Robbins2013 Ch 4: Some more effective graphs in one or two dimensions |
|  | Fri | @Kostelnick1998 Conflicting standards |
| 3 | Thu | @Kostelnick2007 The conundrum of clarity. [Written response form](cm/read-01_reading-response-form.pdf) required for discussion.|
...
|   | Fri | @Wainer1997 How to display data badly |
| 5 | Tue | @Doumont2009  Designing the graph |
|   | Thu | @Wainer2014 Fifteen displays about one thing. [Written response form](cm/read-01_reading-response-form.pdf) required for discussion. |
...
| 8 | Thu | @DraggaVoss2001 Cruel pies.  [Written response form](cm/read-01_reading-response-form.pdf) required for discussion. |
...
|   | Thu | @Spence2006 William Playfair. [Written response form](cm/read-01_reading-response-form.pdf) required for discussion. |
